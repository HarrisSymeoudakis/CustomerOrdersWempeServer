...
app.get("/swagger/AllCustomerActiveOrders", async (req, res) => {
  try {
    const url =
      "https://90571062-test-retail-ondemand.cegid.cloud/Y2/90571062_002_TEST/api/customer-documents/v1?documentType=CustomerOrder&active=true&fields=DiscountsDetail";
